    ...
    <footer className="bg-skitm-navy text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* About Column */}
          <div>
            <h3 className="text-xl font-display font-bold mb-4">SKITM</h3>
            <p className="text-gray-300 mb-4">
              Shivaji Rao Kadam Institute of Technology and Management, established with the vision of providing quality technical education to empower students with knowledge, skills, and values.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/about" className="text-gray-300 hover:text-white transition-colors">About SKITM</Link>
              </li>
              <li>
                <Link to="/courses" className="text-gray-300 hover:text-white transition-colors">Courses Offered</Link>
              </li>
              <li>
                <Link to="/admissions" className="text-gray-300 hover:text-white transition-colors">Admissions</Link>
              </li>
              <li>
                <Link to="/placements" className="text-gray-300 hover:text-white transition-colors">Placements</Link>
              </li>
              <li>
          ...
          {/* Academics */}
          <div>
            <h3 className="text-xl font-display font-semibold mb-4">Academics</h3>
            <ul className="space-y-2">
              <li>
                <Link to="/departments" className="text-gray-300 hover:text-white transition-colors">Departments</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                <MapPin size={20} className="text-skitm-blue mt-1 mr-3 flex-shrink-0" />
                <p className="text-gray-300">
                  Near Rau Industrial Area, Indore - Ujjain Highway, Indore, Madhya Pradesh, India - 453331
                </p>
              </div>
              <div className="flex items-center">
                <Phone size={20} className="text-skitm-blue mr-3 flex-shrink-0" />
                <a href="tel:+917314013344" className="text-gray-300 hover:text-white transition-colors">
                  +91 731 401 3344
                </a>
              </div>
              <div className="flex items-center">
                <Mail size={20} className="text-skitm-blue mr-3 flex-shrink-0" />
                <a href="mailto:info@skitm.in" className="text-gray-300 hover:text-white transition-colors">
                  info@skitm.in
                </a>
              </div>
            </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © {new Date().getFullYear()} SKITM, Indore. All Rights Reserved.
          </p>
