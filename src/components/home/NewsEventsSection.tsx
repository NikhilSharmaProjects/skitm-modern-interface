                ...
                : [
                      {
                          ...
                          date: "2023-05-15",
                          description:
                              'SKITM announces its annual technical festival "Innovision 2023" scheduled for next month with exciting competitions and workshops.',
                          imageUrl:
                      ...
                      },
                      {
                          ...
                          date: "2023-04-28",
                          description:
                              "SKITM has partnered with Microsoft to provide specialized training and certification opportunities for students.",
                          imageUrl:
                              "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1350&q=80",
                          category: "news",
                      },
                      {
                          id: "3",
                          ...
                          date: "2023-04-10",
                          description:
                              "Aman Sharma, a third-year CSE student, secured first place in the national-level coding competition organized by TechElevate.",
                          imageUrl:
                              "https://images.unsplash.com/photo-1557200134-90327ee9fafa?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1350&q=80",
            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {combinedItems.map((item, index) => {
                        const isEvent =
                            "location" in item || item.category === "event";
                        const itemImage = isEvent
                            ? (item as Event).image
                            : (item as NewsEvent).imageUrl;
