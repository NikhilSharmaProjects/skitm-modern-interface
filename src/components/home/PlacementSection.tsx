      ...
      >
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-skitm-gray max-w-2xl mx-auto">
            Our dedicated placement cell works tirelessly to secure excellent career opportunities for our students.
          </p>
        </div>
          ...
          <div className="glassmorphism rounded-xl p-8">
            ...
            <div className="grid grid-cols-2 gap-6 mb-8">
              <div className="text-center">
                <div className="text-4xl font-display font-bold text-skitm-blue mb-2">95%</div>
                <p className="text-sm text-skitm-gray">Placement Rate</p>
              </div>
              <div className="text-center">
                <div className="text-4xl font-display font-bold text-skitm-blue mb-2">12 LPA</div>
                <p className="text-sm text-skitm-gray">Highest Package</p>
              </div>
              <div className="text-center">
                <div className="text-4xl font-display font-bold text-skitm-blue mb-2">5.8 LPA</div>
                <p className="text-sm text-skitm-gray">Average Package</p>
              </div>
              <div className="text-center">
                <div className="text-4xl font-display font-bold text-skitm-blue mb-2">120+</div>
                <p className="text-sm text-skitm-gray">Recruiting Companies</p>
              </div>
            </div>
            ...
            <div className="bg-skitm-navy/5 rounded-lg p-4 mb-6">
              ...
              <ul className="text-sm text-skitm-gray space-y-2">
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-skitm-blue flex-shrink-0 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <li className="flex items-start">
                  ...
                  <span>Aptitude and technical test preparation</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-skitm-blue flex-shrink-0 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
          ...
          <div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
              {companyLogos.map((company) => (
                ...
                >
                  <div className="text-xl font-bold text-skitm-navy">{company.name}</div>
                </div>
              ))}
            </div>
            ...
            <div className="bg-skitm-blue/10 rounded-lg p-6">
              ...
              <p className="text-skitm-gray text-sm italic mb-4">
                "The placement cell at SKITM provided excellent guidance and preparation that helped me secure a job at one of the leading tech companies. The mock interviews and technical training sessions were particularly helpful."
              </p>
              <div className="flex items-center">
                ...
                <div>
                  <div className="text-sm font-semibold text-skitm-navy">Rahul Sharma</div>
                  <div className="text-xs text-skitm-gray">CSE Batch of 2022, Software Engineer at TCS</div>
                </div>
              </div>
            </div>
          </div>
