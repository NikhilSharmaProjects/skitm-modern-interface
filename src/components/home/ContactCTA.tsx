  ...
  return (
    <section className="py-20 bg-white relative overflow-hidden">
      ...
      <div 
        ...
        className={`container mx-auto px-4 relative z-10 ${sectionVisible ? 'animate-fade-in' : 'opacity-0'}`}
      >
        <div className="max-w-3xl mx-auto glassmorphism rounded-xl p-8 md:p-12">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-skitm-gray">
              We're here to help you with any queries regarding admissions, courses, campus life, or anything else.
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white bg-opacity-50 backdrop-blur-sm rounded-lg p-6 text-center">
              <Phone size={28} className="mx-auto mb-4 text-skitm-blue" />
              <h3 className="text-xl font-semibold text-skitm-navy mb-2">Call Us</h3>
              <p className="text-skitm-gray mb-4">Have a quick question? Give us a call.</p>
              <a 
            ...
            <div className="bg-white bg-opacity-50 backdrop-blur-sm rounded-lg p-6 text-center">
              <Mail size={28} className="mx-auto mb-4 text-skitm-blue" />
              <h3 className="text-xl font-semibold text-skitm-navy mb-2">Email Us</h3>
              <p className="text-skitm-gray mb-4">Send us your queries or feedback.</p>
              <a 
