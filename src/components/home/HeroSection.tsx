...
const HeroSection = () => {
  ...
  return (
    <section className="hero-section overflow-hidden">
      ...
      <div className="absolute -bottom-32 -right-32 w-80 h-80 bg-skitm-navy/40 rounded-full filter blur-3xl opacity-30 animate-float" style={{ animationDelay: '2s' }}></div>
        ...
        <div className="max-w-3xl mx-auto text-center text-white">
          ...
          <h1 
            ...
            className={`text-4xl md:text-5xl lg:text-6xl font-display font-bold mb-6 ${
              subtitleVisible ? 'animate-fade-in' : 'opacity-0'
            }`}
            style={{ transitionDelay: '0.4s' }}
          >
            Building Future <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-blue-200">Innovators</span> & <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-blue-200">Leaders</span>
          </h1>
          ...
          >
            Empowering students with cutting-edge technical education, industry connections, and a vibrant campus life in the heart of Madhya Pradesh.
          </p>
          
          <div 
            ref={buttonRef as React.RefObject<HTMLDivElement>}
            className={`flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4 ${
              buttonVisible ? 'animate-fade-in' : 'opacity-0'
            }`}
