      ...
      <main className="flex-grow pt-24 pb-16">
        <div className="container mx-auto px-4">
          ...
          <div className="glassmorphism rounded-xl p-8 text-center">
            <h2 className="text-2xl font-display font-bold text-skitm-navy mb-4">Scholarship Content</h2>
            <p>This page is under development. Check back soon for detailed scholarship information.</p>
          </div>
        </div>
      </main>
