  ...
  const facilities = [
    {
      ...
      title: "Computer Labs",
      description: "State-of-the-art computer labs equipped with the latest hardware and software for practical training and research."
    },
    {
    ...
    },
    {
      ...
      description: "Comprehensive sports facilities including indoor games, outdoor fields, gymnasium, and fitness center."
    },
    {
      icon: <Utensils className="h-10 w-10 text-skitm-blue" />,
      title: "Cafeteria",
      description: "Modern cafeteria serving nutritious and diverse food options in a comfortable dining environment."
    },
    {
      icon: <Wifi className="h-10 w-10 text-skitm-blue" />,
      title: "Wi-Fi Campus",
      description: "High-speed internet connectivity throughout the campus for seamless learning and communication."
    },
    {
      icon: <PenTool className="h-10 w-10 text-skitm-blue" />,
      title: "Design Studios",
      description: "Creative spaces equipped with design software and tools for architecture and design students."
    },
    {
      icon: <Bus className="h-10 w-10 text-skitm-blue" />,
      title: "Transportation",
      description: "Regular shuttle services connecting the campus to major locations in and around the city."
    },
    {
      icon: <BookOpen className="h-10 w-10 text-skitm-blue" />,
      title: "Seminar Halls",
      description: "Spacious seminar and conference halls for academic events, workshops, and guest lectures."
    }
  ];
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-skitm-gray max-w-2xl mx-auto">
              Explore the state-of-the-art facilities available to students at SKITM.
            </p>
          </div>
          ...
          <div className="glassmorphism rounded-xl p-8 mb-16">
            ...
            <div className="aspect-w-16 aspect-h-9">
              <div className="w-full h-full flex items-center justify-center bg-gray-100 rounded-lg">
                <p className="text-skitm-gray">Virtual tour will be available soon</p>
              </div>
            </div>
          </div>
        </div>
