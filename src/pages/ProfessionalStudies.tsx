...
const ProfessionalStudies = () => {
  ...
  const achievements = [
    { icon: <Award className="h-8 w-8 text-white" />, number: "90%", label: "Placement Rate" },
    { icon: <Users className="h-8 w-8 text-white" />, number: "50+", label: "Industry Partners" },
    { icon: <TrendingUp className="h-8 w-8 text-white" />, number: "₹8 LPA", label: "Highest Package" },
    { icon: <Target className="h-8 w-8 text-white" />, number: "100%", label: "Industry Exposure" },
  ];
  ...
  const programs = [
    {
      ...
      description: "3-year program providing strong foundation in business management principles and leadership skills.",
      icon: "💼",
    ...
    },
    {
      ...
      description: "3-year program focusing on commerce, economics, and business principles for finance careers.",
      icon: "📈",
    ...
    },
    {
      ...
      description: "Specialized B.Com program with focus on computer applications and information technology.",
      icon: "💻",
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      >
        <div className="text-center space-y-8">
          ...
          <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
            Building career-ready professionals through industry-aligned education
          </p>
      ...
      <main className="flex-grow">
        ...
        <section className="section-container bg-white">
          <div className="image-first-block mb-20">
            ...
            <div className="image-first-content order-1 lg:order-2">
              <h3 className="section-title">Why Choose Professional Studies?</h3>
              <p className="text-body-lg text-skitm-gray mb-6">
                Our programs are designed with direct input from industry professionals, ensuring graduates are job-ready from day one.
              </p>
              <p className="text-body text-skitm-gray mb-8">
                Technology-enhanced learning combined with digital business skills prepares students for the modern workplace.
              </p>
            </div>
          </div>
        </section>
        ...
        >
          <div className="text-center space-y-8">
            ...
            <div className="flex flex-wrap justify-center gap-6">
              <div className="glassmorphism-dark px-6 py-3 rounded-lg">Banking Sector</div>
              <div className="glassmorphism-dark px-6 py-3 rounded-lg">Financial Services</div>
              <div className="glassmorphism-dark px-6 py-3 rounded-lg">Corporate Management</div>
              <div className="glassmorphism-dark px-6 py-3 rounded-lg">Entrepreneurship</div>
            </div>
          </div>
        </ParallaxSection>
        ...
        <section className="section-container bg-white">
          <div className="text-center space-y-8">
            <h2 className="section-title">Start Your Professional Journey</h2>
            <p className="text-body-lg text-skitm-gray max-w-2xl mx-auto">
              Join our professional studies programs and build a successful career in business
            </p>
            <Link to="/admissions">
