...
const Admissions = () => {
  ...
  const { ref: processRef, isVisible: processVisible } = useScrollAnimationDiv();
  const { ref: eligibilityRef, isVisible: eligibilityVisible } = useScrollAnimationDiv();
  ...
  const admissionSteps = [
    {
      ...
      description: "Fill out the online application form with all required personal and academic details.",
    },
    {
      icon: <CalendarCheck className="h-8 w-8 text-white" />,
      title: "Entrance Examination",
      description: "Appear for the university entrance exam or submit valid GATE/CAT/MAT scores.",
    },
    {
      icon: <GraduationCap className="h-8 w-8 text-white" />,
      title: "Document Verification",
      description: "Submit original documents for verification as per the checklist provided.",
    },
    {
      icon: <CheckCircle className="h-8 w-8 text-white" />,
      title: "Admission Confirmation",
      description: "Pay the admission fee and complete the enrollment process to secure your seat.",
    }
  ];
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-skitm-gray max-w-2xl mx-auto">
              Take the first step towards a successful career by applying to SKITM's prestigious programs.
            </p>
          </div>
          ...
          <div 
            ref={processRef}
            className={`mb-16 ${processVisible ? 'animate-fade-in' : 'opacity-0'}`}
          >
                ...
                {admissionSteps.map((step, index) => (
                  <div 
                    ...
                    className={`flex md:items-center gap-6 ${
                      index % 2 === 0 ? 'md:flex-row md:justify-end md:text-right' : 'md:flex-row-reverse md:justify-end'
                    }`}
                  >
          ...
          <div 
            ref={eligibilityRef}
            className={`mb-16 ${eligibilityVisible ? 'animate-fade-in' : 'opacity-0'}`}
          >
            <h2 className="text-2xl font-display font-bold text-skitm-navy text-center mb-10">
              Eligibility Criteria
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="glassmorphism rounded-xl overflow-hidden">
                ...
                <div className="p-6">
                  <ul className="space-y-4">
                    {eligibilityCriteria.undergraduate.map((criterion, index) => (
                      <li key={index} className="flex items-start gap-3">
                        <CheckCircle className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                        <span className="text-skitm-gray">{criterion}</span>
                      </li>
                    ))}
                  </ul>
                </div>
              ...
              <div className="glassmorphism rounded-xl overflow-hidden">
                ...
                <div className="p-6">
                  <ul className="space-y-4">
                    {eligibilityCriteria.postgraduate.map((criterion, index) => (
                      <li key={index} className="flex items-start gap-3">
                        <CheckCircle className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                        <span className="text-skitm-gray">{criterion}</span>
                      </li>
              ...
              <div className="glassmorphism rounded-xl overflow-hidden">
                ...
                <div className="p-6">
                  <ul className="space-y-4">
                    {eligibilityCriteria.phd.map((criterion, index) => (
                      <li key={index} className="flex items-start gap-3">
                        <CheckCircle className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                        <span className="text-skitm-gray">{criterion}</span>
                      </li>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4">
                {requiredDocuments.map((document, index) => (
                  <div key={index} className="flex items-start gap-3">
                    ...
                    <span className="text-skitm-gray">{document}</span>
                  </div>
                ))}
              </div>
            </div>
              ...
              <div className="relative overflow-x-auto">
                <table className="w-full text-left">
                  <thead className="bg-gray-50 text-skitm-navy">
                    <tr>
                      <th className="px-6 py-3 font-display">Event</th>
                      <th className="px-6 py-3 font-display">Undergraduate</th>
                      <th className="px-6 py-3 font-display">Postgraduate</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr className="border-b">
                      <td className="px-6 py-4 font-medium">Application Start Date</td>
                      <td className="px-6 py-4">15th January 2023</td>
                      <td className="px-6 py-4">1st February 2023</td>
                    </tr>
                    <tr className="border-b bg-gray-50">
                      <td className="px-6 py-4 font-medium">Application Deadline</td>
                      <td className="px-6 py-4">30th April 2023</td>
                      <td className="px-6 py-4">15th May 2023</td>
                    </tr>
                    <tr className="border-b">
                      <td className="px-6 py-4 font-medium">Entrance Examination</td>
                      <td className="px-6 py-4">15th May 2023</td>
                      <td className="px-6 py-4">1st June 2023</td>
                    </tr>
                    <tr className="border-b bg-gray-50">
                      <td className="px-6 py-4 font-medium">Result Declaration</td>
                      <td className="px-6 py-4">10th June 2023</td>
                      <td className="px-6 py-4">20th June 2023</td>
                    </tr>
                    <tr>
                      <td className="px-6 py-4 font-medium">Commencement of Classes</td>
                      <td className="px-6 py-4">1st August 2023</td>
                      <td className="px-6 py-4">15th August 2023</td>
                    </tr>
                  </tbody>
                </table>
              </div>
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="glassmorphism rounded-xl p-6 text-center">
                ...
                <div className="text-3xl font-bold text-skitm-blue mb-3">₹1,200</div>
                <p className="text-sm text-skitm-gray mb-4">General/OBC Category</p>
                <div className="text-3xl font-bold text-skitm-blue mb-3">₹800</div>
                <p className="text-sm text-skitm-gray">SC/ST/PwD Category</p>
              </div>
              ...
              <div className="glassmorphism rounded-xl p-6 text-center">
                ...
                <div className="text-3xl font-bold text-skitm-blue mb-3">₹1,500</div>
                <p className="text-sm text-skitm-gray mb-4">General/OBC Category</p>
                <div className="text-3xl font-bold text-skitm-blue mb-3">₹1,000</div>
                <p className="text-sm text-skitm-gray">SC/ST/PwD Category</p>
              </div>
              ...
              <div className="glassmorphism rounded-xl p-6 text-center">
                ...
                <div className="text-3xl font-bold text-skitm-blue mb-3">₹2,000</div>
                <p className="text-sm text-skitm-gray mb-4">General/OBC Category</p>
                <div className="text-3xl font-bold text-skitm-blue mb-3">₹1,500</div>
                <p className="text-sm text-skitm-gray">SC/ST/PwD Category</p>
              </div>
          ...
          <div className="glassmorphism rounded-xl p-8 bg-gradient-to-r from-skitm-navy to-skitm-blue text-white">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="mb-8">
                Take the first step towards your future career by applying today or contact our admissions team for guidance.
              </p>
