...
const Admissions = () => {
  const admissionStats = [
    { icon: <FileText className="h-8 w-8 text-white" />, number: "5000+", label: "Applications" },
    { icon: <Calendar className="h-8 w-8 text-white" />, number: "3", label: "Admission Rounds" },
    { icon: <Award className="h-8 w-8 text-white" />, number: "Merit Based", label: "Selection" },
    { icon: <Users className="h-8 w-8 text-white" />, number: "95%", label: "Success Rate" },
  ];

  const admissionProcess = [
    {
      title: "Application Submission",
      description: "Submit your online application with required documents and application fee",
      image: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80"
    },
    {
      title: "Entrance Examination",
      description: "Appear for entrance test based on your chosen program and category",
      ...
      >
        <div className="text-center space-y-8">
          ...
          <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
            Begin your journey towards academic excellence and professional success
          </p>
        ...
        >
          <div className="text-center space-y-8">
            ...
            <div className="flex flex-wrap justify-center gap-6">
              <div className="glassmorphism-dark px-6 py-3 rounded-lg">Application: March 2024</div>
              <div className="glassmorphism-dark px-6 py-3 rounded-lg">Entrance Test: May 2024</div>
              <div className="glassmorphism-dark px-6 py-3 rounded-lg">Results: June 2024</div>
              <div className="glassmorphism-dark px-6 py-3 rounded-lg">Admission: July 2024</div>
            </div>
          </div>
        </ParallaxSection>
      </main>
