...
const Academics = () => {
  const stats = [
    ...
    { icon: <Users className="h-8 w-8 text-white" />, number: "150+", label: "Expert Faculty" },
    { icon: <Award className="h-8 w-8 text-white" />, number: "95%", label: "Graduate Success" },
    { icon: <TrendingUp className="h-8 w-8 text-white" />, number: "85%", label: "Placement Rate" },
  ];

  const schools = [
    {
      title: "Engineering",
      description: "Advanced engineering programs with industry-focused curriculum",
      image: "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      link: "/engineering",
      programs: ["Computer Science", "Electronics", "Civil", "Mechanical", "Applied Science"]
    },
    {
      title: "Management",
    ...
    },
    {
      ...
      description: "Diverse programs preparing students for professional careers",
      image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      link: "/professional-studies",
      programs: ["BBA", "B.Com Computer Applications", "B.Com General", "B.Com Honours"]
    },
    {
      title: "Transnational School of Law",
      description: "Legal education with global perspective and practical training",
            ...
            {schools.map((school, index) => (
              <div key={index} className={`image-first-block ${index % 2 === 1 ? 'lg:flex-row-reverse' : ''}`}>
                ...
                <div className={`image-first-content ${index % 2 === 1 ? 'order-2 lg:order-1' : 'order-1 lg:order-2'}`}>
                  <h3 className="section-title">{school.title}</h3>
