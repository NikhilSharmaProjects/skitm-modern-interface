    ...
    return (
        <div className="min-h-screen flex flex-col">
            <Helmet>
                ...
                <meta
                    name="description"
                    content="Read insightful articles and blogs from SKITM about admissions, campus life, career guidance, research, and more. Stay updated with the latest from our college community."
                />
                <meta
                    name="keywords"
                    content="SKITM blogs, college blogs, engineering education, campus life, admission guide, career advice, research news"
                />
                <meta property="og:title" content="Blogs - SKITM" />
                <meta
                    property="og:description"
                    content="Read insightful articles and blogs from SKITM about admissions, campus life, career guidance, research, and more."
                />
                ...
                <div className="container mx-auto px-4">
                    ...
                    >
                        ...
                        <p className="text-lg text-skitm-gray max-w-2xl mx-auto">
                            Discover insights, stories, and knowledge from our
                            college community
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                        {filteredBlogs.length > 0 ? (
                            filteredBlogs.map((post) => (
                                <article
                                    key={post.id}
                                    className="glassmorphism rounded-xl overflow-hidden hover:shadow-lg transition-shadow"
                                >
                            ...
                            <div className="col-span-3 text-center py-12">
                                <p className="text-gray-500">
                                    No blogs found in this category. Check back
                    ...
                    <div className="glassmorphism rounded-xl p-8 text-center">
                        ...
                        <p className="text-skitm-gray mb-6 max-w-2xl mx-auto">
                            Are you a student, faculty member, or alumnus with
                            insights to share? We welcome guest contributions to
                            our blog.
                        </p>
                        <Link
                            to="/contact"
