...
const Departments = () => {
  ...
  const stats = [
    { icon: <Code className="h-8 w-8 text-white" />, number: "6", label: "Departments" },
    { icon: <Cpu className="h-8 w-8 text-white" />, number: "25+", label: "Programs" },
    { icon: <Cog className="h-8 w-8 text-white" />, number: "150+", label: "Faculty Members" },
    { icon: <Building className="h-8 w-8 text-white" />, number: "95%", label: "Placement Rate" },
  ];
  ...
  const departments = [
    {
      ...
      description: "Cutting-edge education in algorithms, programming, AI, ML, and cybersecurity with industry-focused curriculum.",
    ...
    },
    {
      ...
      description: "Comprehensive knowledge in communication systems, embedded systems, and signal processing applications.",
    ...
    },
    {
      ...
      description: "Advanced studies in thermodynamics, robotics, manufacturing, and structural analysis with modern laboratories.",
      icon: <Cog className="h-8 w-8 text-skitm-blue" />,
      courses: ["B.Tech in ME", "M.Tech in ME", "Ph.D. in ME"],
      image: "https://images.unsplash.com/photo-1581092335878-f65169d2f3d8?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80"
    },
    {
      id: 4,
      name: "Civil Engineering",
      description: "Sustainable infrastructure development, construction technology, and environmental engineering solutions.",
    ...
    },
    {
      id: 5,
      name: "Pharmacy",
      description: "Excellence in pharmaceutical sciences, drug development, and healthcare system management.",
    ...
    },
    {
      id: 6,
      name: "Law",
      description: "Comprehensive legal education with global perspective, practical training, and ethical foundation.",
      ...
      >
        <div className="text-center space-y-8">
          ...
          <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
            Diverse academic departments offering world-class education and research opportunities
          </p>
        ...
        <section className="section-container bg-white">
          ...
          <div className="space-y-16">
            {departments.map((department, index) => (
              <div key={department.id} className={`image-first-block ${index % 2 === 1 ? 'lg:flex-row-reverse' : ''}`}>
                ...
                <div className={`image-first-content ${index % 2 === 1 ? 'order-2 lg:order-1' : 'order-1 lg:order-2'}`}>
                  ...
                  <div className="mb-8">
                    <h4 className="font-semibold text-skitm-navy mb-3">Programs Offered:</h4>
                  ...
                  <Link to={`/departments/${department.name.toLowerCase().replace(/\s+/g, '-')}`}>
        ...
        >
          <div className="text-center space-y-8">
            ...
            <div className="flex flex-wrap justify-center gap-6">
              <div className="glassmorphism-dark px-6 py-3 rounded-lg">Cutting-edge Research</div>
              <div className="glassmorphism-dark px-6 py-3 rounded-lg">Industry Collaboration</div>
              <div className="glassmorphism-dark px-6 py-3 rounded-lg">Innovation Centers</div>
              <div className="glassmorphism-dark px-6 py-3 rounded-lg">Patent Publications</div>
            </div>
          </div>
        </ParallaxSection>
      </main>
