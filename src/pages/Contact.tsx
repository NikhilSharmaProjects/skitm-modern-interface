...
const Contact = () => {
  const contactInfo = [
    { icon: <Phone className="h-8 w-8 text-white" />, label: "Phone", value: "+91 9770907100" },
    { icon: <Mail className="h-8 w-8 text-white" />, label: "Email", value: "info@skitm.in" },
    { icon: <MapPin className="h-8 w-8 text-white" />, label: "Address", value: "Indore, Madhya Pradesh" },
    { icon: <Clock className="h-8 w-8 text-white" />, label: "Office Hours", value: "9 AM - 5 PM" },
  ];
          ...
          <div className="image-first-block">
            <div className="order-2 lg:order-1">
              <div className="bg-gradient-to-br from-skitm-blue/10 to-skitm-navy/10 rounded-2xl h-[500px] flex items-center justify-center shadow-2xl">
                <div className="text-center space-y-4">
                  ...
                  <h3 className="text-2xl font-display font-bold text-skitm-navy">Visit Our Campus</h3>
                  <p className="text-skitm-gray">Interactive map and directions coming soon</p>
                </div>
              </div>
            </div>
            <div className="image-first-content order-1 lg:order-2">
              ...
              <p className="text-body-lg text-skitm-gray mb-6">
                Plan your visit to our beautiful campus and experience the SKITM difference firsthand.
              </p>
              <div className="space-y-4">
                <div className="flex items-start">
                  <MapPin className="h-5 w-5 text-skitm-blue mt-1 mr-3 flex-shrink-0" />
                  <p className="text-skitm-gray">
                    Near Ralamandal Sanctuary, Tillore Khurd, Indore - 452020, Madhya Pradesh
                  </p>
                </div>
                <div className="flex items-center">
                  <Phone className="h-5 w-5 text-skitm-blue mr-3 flex-shrink-0" />
                  <a href="tel:+919770907100" className="text-skitm-gray hover:text-skitm-blue transition-colors">
                    +91 9770907100
                  </a>
                </div>
                <div className="flex items-center">
                  <Mail className="h-5 w-5 text-skitm-blue mr-3 flex-shrink-0" />
                  <a href="mailto:info@skitm.in" className="text-skitm-gray hover:text-skitm-blue transition-colors">
                    info@skitm.in
                  </a>
                </div>
              </div>
        ...
        >
          <div className="text-center space-y-8">
            ...
            <div className="flex flex-wrap justify-center gap-6">
              <div className="glassmorphism-dark px-6 py-3 rounded-lg">Campus Tours</div>
              <div className="glassmorphism-dark px-6 py-3 rounded-lg">Admission Guidance</div>
              <div className="glassmorphism-dark px-6 py-3 rounded-lg">Career Counseling</div>
              <div className="glassmorphism-dark px-6 py-3 rounded-lg">24/7 Support</div>
            </div>
          </div>
        </ParallaxSection>
      </main>
