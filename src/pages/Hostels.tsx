...
import { Bed, Coffee, Shield, Users, Wifi, Utensils, BookOpen, Dumbbell } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: "Well-furnished rooms with beds, desks, wardrobes, and attached/common bathrooms"
    },
    {
      icon: <Wifi className="h-6 w-6 text-skitm-blue" />,
      title: "High-Speed Internet",
      description: "24/7 Wi-Fi connectivity throughout all hostel buildings"
    },
    {
      icon: <Utensils className="h-6 w-6 text-skitm-blue" />,
      title: "Mess Facility",
      description: "Nutritious meals served three times a day with additional canteen options"
    },
    {
    ...
    },
    {
      ...
      description: "Indoor games, TV rooms, and fitness areas for physical well-being"
    },
    {
      icon: <Coffee className="h-6 w-6 text-skitm-blue" />,
      title: "Common Rooms",
      description: "Spacious common areas for socializing and community activities"
    },
    {
  ...
  const hostelBuildings = [
    {
      ...
      description: "Modern residential facility for male students with various room configurations",
    ...
    },
    {
      ...
      description: "Secure and comfortable accommodation for female students with enhanced facilities",
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-skitm-gray max-w-2xl mx-auto">
              Experience comfortable and secure residential life at SKITM's on-campus hostels.
            </p>
          </div>
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between mb-4">
                      <div className="text-sm text-skitm-gray">
                        <span className="font-medium">Capacity:</span> {hostel.capacity}
                      </div>
                      
                      <div className="text-sm text-skitm-gray">
                        <span className="font-medium">Room Types:</span> {hostel.roomTypes.join(", ")}
                      </div>
                    </div>
          ...
          <div className="glassmorphism rounded-xl p-8">
            ...
            <div className="max-w-3xl mx-auto">
              <ul className="list-disc list-inside space-y-3 text-skitm-gray">
                <li>Students must maintain discipline and follow the code of conduct at all times.</li>
                <li>Hostel entry and exit are monitored. Gates close at 10:00 PM for security reasons.</li>
                <li>Visitors are allowed only in designated visitor areas during specified hours.</li>
                <li>Consumption of alcohol, tobacco, and prohibited substances is strictly forbidden.</li>
                <li>Students are responsible for keeping their rooms and common areas clean.</li>
                <li>Conservation of electricity and water is encouraged.</li>
                <li>Any damage to hostel property will result in appropriate penalties.</li>
                <li>Ragging in any form is strictly prohibited and will lead to severe consequences.</li>
                <li>Students requiring medical attention should inform the hostel warden immediately.</li>
                <li>Hostel fee must be paid on time as per the academic calendar.</li>
              </ul>
            </div>
          </div>
        </div>
