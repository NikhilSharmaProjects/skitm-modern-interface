...
const Pharmacy = () => {
  ...
  const achievements = [
    { icon: <Award className="h-8 w-8 text-white" />, number: "95%", label: "Graduate Success" },
    { icon: <Users className="h-8 w-8 text-white" />, number: "200+", label: "Industry Partners" },
    { icon: <BookOpen className="h-8 w-8 text-white" />, number: "15+", label: "Research Projects" },
    { icon: <Target className="h-8 w-8 text-white" />, number: "100%", label: "Placement Rate" },
  ];
  ...
  const programs = [
    {
      ...
      description: "Comprehensive 4-year program covering pharmaceutical sciences, drug development, and healthcare systems.",
      icon: "💊",
    ...
    },
    {
      ...
      description: "2-year diploma providing essential pharmaceutical education for pharmacy assistants and technicians.",
      icon: "🧪",
    ...
    },
    {
      ...
      description: "Advanced 2-year postgraduate program with specializations for pharmaceutical research.",
      icon: "🔬",
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      >
        <div className="text-center space-y-8">
          ...
          <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
            Nurturing professionals in pharmaceutical sciences through innovation and research
          </p>
      ...
      <main className="flex-grow">
          ...
          <div className="image-first-block mb-20">
            ...
            <div className="image-first-content order-1 lg:order-2">
              ...
              <p className="text-body-lg text-skitm-gray mb-6">
                Our pharmaceutical education combines cutting-edge research with practical training in modern laboratories equipped with the latest instruments.
              </p>
              <p className="text-body text-skitm-gray mb-8">
                From drug development to clinical pharmacy, our comprehensive programs prepare students for successful careers in the pharmaceutical industry.
              </p>
            </div>
          </div>
        </section>
        ...
        >
          <div className="text-center space-y-8">
            ...
            <div className="flex flex-wrap justify-center gap-6">
              <div className="glassmorphism-dark px-6 py-3 rounded-lg">Research Projects</div>
              <div className="glassmorphism-dark px-6 py-3 rounded-lg">Industrial Training</div>
              <div className="glassmorphism-dark px-6 py-3 rounded-lg">Hospital Internships</div>
              <div className="glassmorphism-dark px-6 py-3 rounded-lg">Pharma Conferences</div>
            </div>
          </div>
        </ParallaxSection>
        ...
        <section className="section-container bg-white">
          <div className="text-center space-y-8">
            <h2 className="section-title">Start Your Pharmaceutical Career</h2>
            <p className="text-body-lg text-skitm-gray max-w-2xl mx-auto">
              Join our distinguished pharmacy programs and become part of the healthcare revolution
            </p>
            <Link to="/admissions">
