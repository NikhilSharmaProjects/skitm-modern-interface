...
import { Book, User, GraduationCap, CreditCard, Clock, Building } from 'lucide-react';
  ...
  const faqCategories = [
    ...
    },
    {
      ...
      faqs: [
        ...
        {
          question: "Are there any exchange programs with foreign universities?",
    ...
    },
    {
      ...
      faqs: [
        ...
        {
          question: "What payment options are available for tuition fees?",
    ...
    },
    {
      ...
      faqs: [
        {
          question: "What companies visit SKITM for campus placements?",
          answer: "SKITM has a strong placement record with top companies like Microsoft, Google, Amazon, IBM, Infosys, TCS, and many more visiting for campus recruitments."
        },
        {
              ...
              <div className="glassmorphism rounded-xl p-6">
                <Accordion type="single" collapsible className="space-y-4">
                  {category.faqs.map((faq, index) => (
                    <AccordionItem key={index} value={`${category.id}-item-${index}`} className="border-b border-gray-200 last:border-0">
